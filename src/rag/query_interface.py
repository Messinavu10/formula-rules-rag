...
class FIAQueryInterface:
    ...
    def ask_question(self,  #calls the rag pipeline
                    question: str,
    ...
    def ask_followup(self, question: str, use_compression: bool = False) -> Dict[str, Any]:
        """
    ...
    def _format_response(self, result: Dict[str, Any], include_sources: bool = True) -> Dict[str, Any]:
        """
